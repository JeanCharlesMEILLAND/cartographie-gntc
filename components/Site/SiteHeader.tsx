...
const NAV: NavItem[] = [
  ...
  { label: 'Carte', href: '/carte' },
  {
    ...
    children: [
      ...
      { label: 'Plateformes', href: '/acteurs/plateformes' },
      { label: 'Op\u00e9rateurs', href: '/acteurs/operateurs' },
      { label: 'Ferroviaire', href: '/acteurs/ferroviaire' },
      { label: 'Fluvial', href: '/acteurs/fluvial' },
    ],
  },
